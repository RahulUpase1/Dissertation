...
class BasicAgent(object):
    ...
    def add_emergency_stop(self, control): #NEED THIS FUNCTION FOR EMERGENCY STOPPING
        """
    ...
    def lane_change(self, direction, same_lane_time=0, other_lane_time=0, lane_change_time=2): #NEED THIS FUNCTION FOR MY PROGRAM
        """
    ...
    def _vehicle_obstacle_detected(self, vehicle_list=None, max_distance=None, up_angle_th=90, low_angle_th=0, lane_offset=0): #NEED THIS WHOLE FUNCTION
        """
